...
module.exports = {
    addRoutes: () => { //routes er en minificeret del af express app, en mindre del af app. Router er noget funktionalitet, der bruger appen, men når den defineres, er det en mindre del
